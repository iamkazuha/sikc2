    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                        ...
                        <a href="https://pagedone.io/" class="flex justify-center lg:justify-start">
                            <img src="{{ asset('img/logotelkomwhite.png') }}" alt="Your Logo" class="w-40 h-16 object-contain">
                        </a>
                                
                        <p class="py-8 text-sm text-white lg:max-w-xs text-center lg:text-left flex items-center">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2C8.68629 2 6 4.68629 6 8C6 11.7698 10.448 19.6084 11.2668 21.0192C11.613 21.5907 12.3867 21.5907 12.7329 21.0192C13.5517 19.6084 18 11.7698 18 8C18 4.68629 15.3137 2 12 2ZM12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6C13.1046 6 14 6.89543 14 8C14 9.10457 13.1046 10 12 10Z" />
    </svg>
    Gd. Selaru, Universitas Telkom, Bandung, Indonesia
</p>
                        ...
                        <div class="lg:mx-auto text-left ">
                            ...
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6"><a href="javascript:;"  class=" text-gray-300 hover:text-gray-900">Home</a></li>
                                <li class="mb-6"><a href="javascript:;"  class=" text-gray-300 hover:text-gray-900">About</a></li>
                                <li><a href="javascript:;"  class=" text-gray-300 hover:text-gray-900">Pricing</a></li>
                            </ul>
                        </div>
                        <!--End Col-->
                        <div class="lg:mx-auto text-left ">
                            ...
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6"><a href="javascript:;"  class="text-gray-300 hover:text-gray-900">Figma UI System</a></li>
                                <li class="mb-6"><a href="javascript:;"  class=" text-gray-300 hover:text-gray-900">Icons Assets</a></li>
                                <li><a href="javascript:;"  class=" text-gray-300 hover:text-gray-900">Responsive Blocks</a></li>
                            </ul>
                        </div>
                        <!--End Col-->
                        <div class="lg:mx-auto text-left ">
                            ...
                            <ul class="text-sm  transition-all duration-500">
                                <li class="mb-6"><a href="javascript:;"  class="text-gray-300 hover:text-gray-900">Customer Support</a></li>
                                <li class="mb-6"><a href="javascript:;"  class=" text-gray-300 hover:text-gray-900">Terms & Conditions</a></li>
                                <li ><a href="javascript:;"  class=" text-gray-300 hover:text-gray-900">Privacy Policy</a></li>
                            </ul>
                        </div>
                        <!--End Col-->
                        <div class="lg:mx-auto text-left ">
                            <h4 class="text-lg text-white font-medium mb-7">Subscribe</h4>
                            <p class="text-sm text-gray-300 leading-6 mb-7">Subscribe to get the latest news from us</p>
                    ...
                    <div class="py-7 border-t border-gray-200">
                        <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                            <span class="text-sm text-white ">Copyright © 2024 - Smart City Information System, All Rights Reserved</span>
